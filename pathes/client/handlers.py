...
async def startCommand(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        '<b>💎 Добро пожаловать в умную ферму киви кошельков\
        \n\n- Моментальные выводы\
        \n- Настройки выводов\
        \n- Вывод на киви / Карту\
        \n- Бесплатный доступ\
...
"""
Изменение статуса АвтоБлокировки и Уведомление о балансе
"""
...
"""
Обновление минимальной суммы вывода
"""
